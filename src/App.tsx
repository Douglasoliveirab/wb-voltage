...
import imgTransformadores from "./assets/imagens/banner.jpg";
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="px-4 py-8 text-center">
        <p className="text-lg font-medium text-gray-700 mb-6 max-w-3xl mx-auto leading-relaxed">
          A WB Voltage tem mais de 5 anos de experiência no mercado de manutenção de cabines
          primárias e transformadores elétricos.        </p>
          ...
          {services.map((service, index) => (
            <div key={index} className="text-center">
              <img
                src={service.img}
                alt={service.name}
                className="w-32 h-32 sm:w-40 sm:h-40 object-cover rounded-full shadow-lg mx-auto
      ...
      <div className="px-4 py-8 text-center bg-gray-100">
        ...
        <p className="text-base text-gray-700 max-w-2xl mx-auto leading-relaxed">
          Na WB Voltage, estamos comprometidos com a excelência e qualidade dos serviços que oferecemos.
          Nossa equipe é formada por profissionais altamente capacitados,
          prontos para atender a todas as suas necessidades em manutenção de cabines primárias
          e transformadores elétricos, garantindo máxima eficiência e segurança em todos os processos.        </p>
      </div>
      ...
      <a
        href="https://wa.me/5511982506224?text=Olá, estou interessado em saber mais sobre os
         serviços da WB voltage. Poderiam me ajudar?"
        target="_blank"
        rel="noopener noreferrer"
        className="fixed bottom-5 right-5 bg-green-500 text-white rounded-full p-3 shadow-lg
